...
const features = [
  {
    id: 'up-next', label: 'UP NEXT', title: 'Walk into the day with context.',
  ...
  {
    id: 'this-month', label: 'THIS MONTH', title: 'See what’s coming into focus.',
  ...
  {
    id: 'tips', anchor: 'tip-inbox', label: 'HUSH LINE · TIP INBOX', title: 'Give important messages their own space.',
  ...
  {
    id: 'recommendations', label: 'WHO TO TALK TO', title: 'Find a reason to reconnect.',
  ...
  {
    id: 'activity', label: 'WEEKLY ACTIVITY', title: 'Get a feel for your week.',
